...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'INFORME',
            'url'  => 'https://drive.google.com/drive/folders/1tij7b-IQlQ_kMXN9EMq0i-P9PX9AF8s7',
            'icon' => 'fas fa-fw fa-share',
        ],
        [
            'text' => 'INFORME DE EVENTOS',
            'url'  => 'https://drive.google.com/drive/folders/1Vc0qofwaXmeBe2X5z5MDPlQ1j1TIqwv0',
            'icon' => 'fas fa-fw fa-share',
        ],
